...
def RandomForestByRegionYear(dataset, output, predictionIndicatorYear, predictionIndicatorRegion):
      ...
      #TODO apagar
      outputFinal = train_features.pop(output)
      train_features, test_features1, train_labels, test_labels1 = train_test_split(train_features, outputFinal, test_size=1-config.fracUsedToTraining, random_state=0)
      #TODO apagar
      ...
      space['max_features'] = [2, 4, 6, 8, 10, 12, 14, 16]
